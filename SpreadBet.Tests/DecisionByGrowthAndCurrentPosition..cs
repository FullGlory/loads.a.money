...
namespace SpreadBet.Tests
{
	...
	public class DecisionByGrowthAndCurrentPositionTests
	{
		...
		public void GetInvestmentDecisions_BettingOnIncrease_ReturnsBet()
		{
			...
			history.Prices.Add(new Period { Id = 7, To = lastPeriodEnd.AddHours(0) }, new Price { Mid = 35.40m, Bid = 37.23m, Offer = 23.23m });
			...
			Assert.AreEqual(10, bet.BidAmount);
			Assert.AreEqual(17.23m, bet.ExitPrice);
